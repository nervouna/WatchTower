/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=` (hash: d16b7454398297a71efd37afff161094)
// Runtime types generated with workerd@1.20260710.1 2026-07-15
interface __BaseEnv_Env {
	BRIEF_AUDIO: R2Bucket;
	DB: D1Database;
	BRIEF_AUDIO_QUEUE: Queue;
	BRIEF_PUSH_QUEUE: Queue;
	ITEM_EXPLORATION_QUEUE: Queue;
	MOBILE_PUSH_RATE_LIMITER: RateLimit;
	EXPLORATION_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	BRIEF_AUDIO_ENABLED: "false" | "true";
	BRIEF_COVER_ENABLED: "false" | "true";
	BRIEF_PUSH_ENABLED: "false" | "true";
	ITEM_EXPLORATION_ENABLED: "false" | "true";
	ITEM_EXPLORATION_CACHE_TTL_HOURS: "24";
	ITEM_EXPLORATION_DAILY_TAVILY_CREDITS: "120";
...
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		BRIEF_COVER_ENABLED: "false";
		BRIEF_PUSH_ENABLED: "false";
		ITEM_EXPLORATION_ENABLED: "false";
		ITEM_EXPLORATION_CACHE_TTL_HOURS: "24";
		ITEM_EXPLORATION_DAILY_TAVILY_CREDITS: "120";
		ITEM_EXPLORATION_CREDIT_RESERVATION: "12";
		AUTH0_ISSUER: "https://auth.watchtower.damao.io/";
